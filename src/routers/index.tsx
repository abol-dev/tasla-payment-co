...
import PageHome from "containers/AMyPages/PageHome";
import PageProduct from "containers/AMyPages/PageProduct";
import PageLogin from "containers/AMyPages/PageLogin";
import PageSignUp from "containers/AMyPages/PageSignUp";
import Page404 from "containers/AMyPages/Page404";
//
//
//
//
...
import PageCart from "containers/AMyPages/PageCart";

export const pages: Page[] = [
  { path: "/", exact: true, component: PageHome },
  { path: "/#", exact: true, component: PageHome },
  { path: "/product/:slug", component: PageProduct },
