...
const problemPlansDemo = [
  { name: "خشونت", id: "Violence", label: "خشونت" },
  { name: "مشکل", id: "مشکل", label: "مشکل" },
  { name: "اسپم", id: "اسپم", label: "اسپم" },
  { name: "موارد دیگر", id: "موارد دیگر", label: "موارد دیگر" },
];
      ...
      <form action="#">
        ...
        <div className="mt-4">
          ...
          <span className="text-sm text-neutral-6000 dark:text-neutral-400">
            لطفاً هر گونه اطلاعات اضافی یا زمینه ای که به شما کمک می کند ارائه
            دهید ما شرایط را درک کرده و مدیریت می کنیم.
          </span>
          <Textarea
            placeholder="..."
            className="mt-3"
