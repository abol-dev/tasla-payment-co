...
const CommentCard: FC<CommentCardProps> = ({
  ...
  const actions = [
    { id: "edit", name: "ویرایش", icon: "las la-edit" },
    { id: "reply", name: "پاسخ", icon: "las la-reply" },
    { id: "report", name: "گزارش تخلف", icon: "las la-flag" },
    { id: "delete", name: "حذف", icon: "las la-trash-alt" },
  ];
