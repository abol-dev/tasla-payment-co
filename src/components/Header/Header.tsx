...
export interface HeaderProps {
  mainNavStyle?: "Logedout" | "Logedin";
  currentPage: PageItemType;
}

const Header: FC<HeaderProps> = ({
  mainNavStyle = "Logedout",
  currentPage,
}) => {
  ...
  //
  const showSingleMenu = currentPage.type === "/product/:slug";
  //
  ...
  const renderSingleHeader = () => {
    ...
    return (
      <div className="relative py-4 nc-SingleHeaderMenu dark bg-neutral-900 dark:bg-neutral-900">
